...
.pull-right[
```{r, ggload-iris, message=FALSE, warning=FALSE, echo=FALSE, purl=FALSE, fig.height=4,fig.width=4}
```
]
...
Было 4 скоррелированных признака, стало 2 __независимых__ (они ведь перпендикулярны) главных компоненты.

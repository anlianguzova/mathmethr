...
# спят долго, коалы спят долго,
# а  кому-то достаточно лишь немного сна.
...
# Паттерны в остатках ----------------------------------------------
# (графики зависимости остатков от переменных, уже включенных в модель
# и от не включенных в нее)
...
# ## Достоверно различающиеся по результатам пост-хок теста

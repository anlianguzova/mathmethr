...
В 70-е годы в штате Нью-Йорк исследовали 20 речных бассейнов (Haith, 1976), чтобы оценить качество воды. Как влияют особенности землепользования на среднюю концентрацию азота (мг/л) в воде?  
...
2. Запишите уравнение этой линейной модели с коэффициентами.
...
- близость к краям области определения (leverage --- рычаг, сила; называют hat в выводаx некоторыx функций)
